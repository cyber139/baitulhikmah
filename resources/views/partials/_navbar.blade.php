...
<nav class="main-header navbar navbar-expand navbar-dark navbar-secondary">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block">
      <a class="nav-link">YOUR ACCOUNT HAS NOT BEEN VERIFIED BY THE ADMIN. PLEASE CONTACT YOUR ADMIN</a>
    </li>
    {{-- <li class="nav-item d-none d-sm-inline-block">
    ...
    <li class="nav-item d-none d-sm-inline-block">
      <a href="{{route('forum.create')}}" class="nav-link">
          <i class="fas fa-flag nav-icon"></i> Report</a>
    </li>
